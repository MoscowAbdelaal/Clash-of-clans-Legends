...
public class Player {
    ...
    public void upgradeUnit(SupportUnit u) throws InvalidTargetException, NoAvailableResourcesException, InvalidActionException {
        if (!units.contains(u))
    ...
    public void upgradeBuilding(Building b) throws InvalidTargetException, NoAvailableResourcesException, InvalidActionException {
        if (!buildings.contains(b))
            throw new InvalidTargetException("Player can only upgrade his units, an InvalidTargetException should be thrown.");
